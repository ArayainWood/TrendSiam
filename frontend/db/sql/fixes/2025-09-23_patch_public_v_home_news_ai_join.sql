-- =========================================================
-- PATCH HOME VIEW TO USE AI IMAGES BRIDGE VIEW
-- Date: 2025-09-23
--
-- Updates public_v_home_news to join the bridge view
-- public_v_ai_images_latest instead of the base ai_images table.
-- This eliminates permission errors while maintaining the
-- exact 26-column contract.
-- =========================================================

BEGIN;

-- =========================================
-- RECREATE HOME VIEW WITH BRIDGE VIEW JOIN
-- =========================================
...
-- CHANGED: Join with bridge view instead of base table
...
Updated: 2025-09-23 - Uses public_v_ai_images_latest bridge view';
