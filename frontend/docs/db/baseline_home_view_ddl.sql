-- =========================================================
-- BASELINE SNAPSHOT: public.public_v_home_news 
-- Date: 2025-09-23
-- 
-- This file preserves the current DDL for rollback purposes.
-- Current implementation uses date-based freshness (48h + 7d fallback)
-- =========================================================
...
Baseline snapshot created: 2025-09-23';
